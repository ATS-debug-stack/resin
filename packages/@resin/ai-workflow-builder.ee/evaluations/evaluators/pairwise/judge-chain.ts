...
- Chat model sub-nodes (e.g., @resin/nodes-langchain.lmChatAnthropic, @resin/nodes-langchain.lmChatOpenAi) are NOT provider-specific nodes. They are required infrastructure for connecting generic nodes like the AI Agent to a language model.
...
- "@resin/nodes-langchain.chatTrigger" and "resin-nodes-langchain.chatTrigger" are the SAME node type
