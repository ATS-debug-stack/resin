...
Chat Trigger (@resin/nodes-langchain.chatTrigger) is a BIDIRECTIONAL node that handles both input AND output automatically.
...
Document Loader nodes (@resin/nodes-langchain.documentLoader*) are CAPABILITY-ONLY nodes.
