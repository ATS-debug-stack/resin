...
const DEFAULT_SUBNODES: Record<string, string[]> = {
	ai_languageModel: ['@resin/nodes-langchain.lmChatOpenAi'],
	ai_memory: ['@resin/nodes-langchain.memoryBufferWindow'],
	ai_embedding: ['@resin/nodes-langchain.embeddingsOpenAi'],
	ai_vectorStore: ['@resin/nodes-langchain.vectorStoreInMemory'],
