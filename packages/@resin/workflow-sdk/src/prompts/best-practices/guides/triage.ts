...
Use the Text Classifier node (@resin/nodes-langchain.textClassifier) for straightforward text classification tasks. Configure with predefined category labels and descriptions for accurate results.
...
**Text Classifier** (@resin/nodes-langchain.textClassifier):
