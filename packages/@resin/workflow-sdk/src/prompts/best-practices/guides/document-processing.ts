...
**LLM Chain (@resin/nodes-langchain.chainLlm)**
Purpose: Document classification and data extraction

**Document Loader (@resin/nodes-langchain.documentLoader)**
...
**Structured Output Parser (@resin/nodes-langchain.outputParserStructured)**
...
**Simple Vector Store (@resin/nodes-langchain.vectorStore) - RECOMMENDED**
