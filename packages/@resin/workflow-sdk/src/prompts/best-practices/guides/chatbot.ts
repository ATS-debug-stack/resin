...
### Chat Trigger (@resin/nodes-langchain.chatTrigger)
...
- OpenAI Chat Model (@resin/nodes-langchain.lmChatOpenAi)
- Google Gemini Chat Model (@resin/nodes-langchain.lmChatGoogleGemini)
- xAI Grok Chat Model (@resin/nodes-langchain.lmChatXAiGrok)
- DeepSeek Chat Model (@resin/nodes-langchain.lmChatDeepSeek)

Purpose: Connect to LLMs for natural, context-aware responses

### Simple Memory (@resin/nodes-langchain.memoryBufferWindow)
