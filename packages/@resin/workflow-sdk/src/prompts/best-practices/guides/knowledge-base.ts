...
**Document Default Data Loader** (@resin/nodes-langchain.documentDefaultDataLoader):
...
**Text Splitter Recursive Character** (@resin/nodes-langchain.textSplitterRecursiveCharacterTextSplitter):
...
**Embeddings OpenAI** (@resin/nodes-langchain.embeddingsOpenAi):
...
**Vector Store Pinecone** (@resin/nodes-langchain.vectorStorePinecone):
...
**Vector Store Qdrant** (@resin/nodes-langchain.vectorStoreQdrant):
...
**Vector Store Supabase** (@resin/nodes-langchain.vectorStoreSupabase):
...
**Vector Store In Memory** (@resin/nodes-langchain.vectorStoreInMemory):
...
**AI Agent** (@resin/nodes-langchain.agent):
...
**Tool Vector Store** (@resin/nodes-langchain.toolVectorStore):
...
**OpenAI** (@resin/nodes-langchain.openAi):
...
**Memory Window Buffer** (@resin/nodes-langchain.memoryBufferWindow):
