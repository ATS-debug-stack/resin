...
const openAiModel = languageModel({
  type: '@resin/nodes-langchain.lmChatOpenAi', version: 1.3,
...
const aiAgent = node({
  type: '@resin/nodes-langchain.agent', version: 3.1,
  config: {
    name: 'AI Assistant',
...
const calculatorTool = tool({
  type: '@resin/nodes-langchain.toolCalculator', version: 1,
...
const structuredParser = outputParser({
  type: '@resin/nodes-langchain.outputParserStructured', version: 1.3,
  config: {
