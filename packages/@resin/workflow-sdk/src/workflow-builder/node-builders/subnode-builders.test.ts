...
describe('subnode factories', () => {
	...
	describe('languageModel()', () => {
		it('should create a LanguageModelInstance with correct marker', () => {
			...
			expect(model.type).toBe('@resin/nodes-langchain.lmChatOpenAi');
	...
	describe('memory()', () => {
		it('should create a MemoryInstance with correct marker', () => {
			...
			expect(mem.type).toBe('@resin/nodes-langchain.memoryBufferWindow');
		});
	});
	...
	describe('tool()', () => {
		it('should create a ToolInstance with correct marker', () => {
			...
			expect(t.type).toBe('@resin/nodes-langchain.toolCode');
		});
	...
	describe('outputParser()', () => {
		it('should create an OutputParserInstance with correct marker', () => {
			...
			expect(parser.type).toBe('@resin/nodes-langchain.outputParserStructured');
		});
	});
	...
	describe('embedding()', () => {
		it('should create an EmbeddingInstance with correct marker', () => {
			...
			expect(emb.type).toBe('@resin/nodes-langchain.embeddingsOpenAi');
		});
	});
	...
	describe('vectorStore()', () => {
		it('should create a VectorStoreInstance with correct marker', () => {
			const vs = subnodeBuilders.vectorStore({
				type: '@resin/nodes-langchain.vectorStorePinecone',
				version: 1,
				config: {
			...
			expect(vs.type).toBe('@resin/nodes-langchain.vectorStorePinecone');
		});
	});
	...
	describe('retriever()', () => {
		it('should create a RetrieverInstance with correct marker', () => {
			...
			expect(ret.type).toBe('@resin/nodes-langchain.retrieverVectorStore');
		});
	});
	...
	describe('documentLoader()', () => {
		it('should create a DocumentLoaderInstance with correct marker', () => {
			const loader = subnodeBuilders.documentLoader({
				type: '@resin/nodes-langchain.documentDefaultDataLoader',
				version: 1,
				config: {},
			});

			expect(loader._subnodeType).toBe('ai_document');
			expect(loader.type).toBe('@resin/nodes-langchain.documentDefaultDataLoader');
		});
	});
	...
	describe('textSplitter()', () => {
		it('should create a TextSplitterInstance with correct marker', () => {
			const splitter = subnodeBuilders.textSplitter({
				type: '@resin/nodes-langchain.textSplitterCharacterTextSplitter',
				version: 1,
				config: {
			...
			expect(splitter.type).toBe('@resin/nodes-langchain.textSplitterCharacterTextSplitter');
		});
	});
});
...
describe('subnode integration with node builder', () => {
	...
	it('should allow subnodes in node config', () => {
		...
		expect(agent.type).toBe('@resin/nodes-langchain.agent');
