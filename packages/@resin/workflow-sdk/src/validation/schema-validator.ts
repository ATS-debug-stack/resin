 ...
 * - "@resin/nodes-langchain.agent" -> { pkg: "resin-nodes-langchain", nodeName: "agent" }
 */
 ...
 *
 * @param nodeType - Full node type string (e.g., "resin-nodes-base.set", "@resin/nodes-langchain.agent")
