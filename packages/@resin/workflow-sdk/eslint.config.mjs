...
export default defineConfig(
	...
	{
		plugins: {
			'@resin/community-nodes': n8nCommunityNodesPlugin,
		},
		rules: {
	...
	},
	{
		...
		rules: {
			'@resin/community-nodes/no-builder-hint-leakage': ['error', { scope: 'all' }],
		},
	},
	{
		...
		rules: {
			'@resin/community-nodes/no-builder-hint-leakage': 'off',
		},
	},
);
