/**
 * Data for get-suggested-nodes tool.
 * Contains curated node recommendations organized by workflow technique category.
 * Ported from ai-workflow-builder.ee — keeps the instance-ai builder on par.
 */
...
export const suggestedNodesData: Record<string, CategoryData> = {
	...
	data_extraction: {
		...
		nodes: [
			...
			{
				name: '@resin/nodes-langchain.informationExtractor',
	...
	web_app: {
		description:
			'Serving a single-page web application from an n8n webhook — dashboard, admin panel, interactive tool, form with rich UI',
		patternHint:
