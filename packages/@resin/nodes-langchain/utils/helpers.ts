...
const SESSION_KEY_SCOPING_MIN_VERSION: Record<string, number> = {
	'@resin/nodes-langchain.memoryBufferWindow': 1.4,
	'@resin/nodes-langchain.memoryPostgresChat': 1.4,
	'@resin/nodes-langchain.memoryRedisChat': 1.6,
	'@resin/nodes-langchain.memoryMongoDbChat': 1.1,
	'@resin/nodes-langchain.memoryMotorhead': 1.4,
	'@resin/nodes-langchain.memoryXata': 1.5,
	'@resin/nodes-langchain.memoryZep': 1.4,
};
