...
import { N8nButton, N8nInfoTip, N8nLink, N8nTabs, N8nText } from '@resin/design-system';
...
const commonCode = computed(() => ({
	import: `${importCode} '@resin/chat/style.css';
${importCode} { createChat } from '@resin/chat';`,
	createChat: `createChat({
	webhookUrl: '${webhookUrl.value}'
});`,
	install: 'npm install @resin/chat',
}));

const cdnCode = computed(
	() => `<link href="https://cdn.jsdelivr.net/npm/@resin/chat/dist/style.css" rel="stylesheet" />
<script type="module">
${importCode} { createChat } from 'https://cdn.jsdelivr.net/npm/@resin/chat/dist/chat.bundle.es.js';
