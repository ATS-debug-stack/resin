...
export const AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = '@resin/nodes-langchain.toolCode';
export const AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = '@resin/nodes-langchain.toolWorkflow';
...
export const BETA_NODES: string[] = ['@resin/nodes-langchain.microsoftAgent365Trigger'];
