...
export const AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = '@resin/n8n-nodes-langchain.toolCode';
export const AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = '@resin/n8n-nodes-langchain.toolWorkflow';
...
export const BETA_NODES: string[] = ['@resin/n8n-nodes-langchain.microsoftAgent365Trigger'];
