...
import type { ConsentDetails } from '@resin/rest-api-client/api/consent';
import { N8nButton, N8nHeading, N8nIcon, N8nLogo, N8nNotice, N8nText } from '@resin/design-system';
