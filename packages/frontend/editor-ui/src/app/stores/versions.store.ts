import type { IVersionNotificationSettings } from '@resin/api-types';
import * as versionsApi from '@resin/rest-api-client/api/versions';
import {
...
import type { Version, WhatsNewSection } from '@resin/rest-api-client/api/versions';
