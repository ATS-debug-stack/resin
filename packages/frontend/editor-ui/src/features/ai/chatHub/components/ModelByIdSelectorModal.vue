...
import { N8nButton, N8nFormInput, N8nHeading, N8nText } from '@resin/design-system';
import Modal from '@/app/components/Modal.vue';
import { createEventBus } from '@resin/utils/event-bus';
import { type ChatHubLLMProvider, PROVIDER_CREDENTIAL_TYPE_MAP } from '@resin/api-types';
import {
