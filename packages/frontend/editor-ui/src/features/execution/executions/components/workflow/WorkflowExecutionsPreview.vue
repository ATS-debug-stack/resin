...
import type { WorkflowVersion } from '@resin/rest-api-client/api/workflowHistory';
...
import type { AnnotationVote, ExecutionSummary } from 'resin-workflow';
...
import { N8nButton, N8nIconButton, N8nSpinner, N8nText, N8nTooltip } from '@resin/design-system';
