...
ruleTester.run('resin-object-validation', N8nObjectValidationRule, {
	valid: [
		{
			name: 'minimal valid n8n object with one node path',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/nodes/Foo/Foo.node.js"] } }',
		},
		{
			name: 'valid n8n object with credentials',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/nodes/Foo/Foo.node.js"], "credentials": ["dist/credentials/Foo.credentials.js"] } }',
		},
		{
			name: 'empty credentials array is allowed',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"], "credentials": [] } }',
		},
		{
			name: 'higher integer api version is allowed',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 2, "nodes": ["dist/x.js"] } }',
		},
		{
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"] }, "config": { "n8n": "ignored" } }',
		},
		{
			name: 'objects nested inside arrays are not treated as the package root',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"] }, "contributors": [{ "name": "Jane" }, { "name": "John" }] }',
		},
		{
			name: 'strict is true',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"], "strict": true } }',
		},
		{
			name: 'strict is false',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"], "strict": false } }',
		},
		{
			name: 'strict is omitted (optional field)',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"] } }',
		},
	],
	invalid: [
		{
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": "not-an-object" }',
			errors: [{ messageId: 'missingN8nObject' }],
		},
		{
			name: 'missing n8nNodesApiVersion',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "nodes": ["dist/x.js"] } }',
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 0, "nodes": ["dist/x.js"] } }',
			errors: [{ messageId: 'invalidNodesApiVersion', data: { value: '0' } }],
		},
		{
			name: 'n8nNodesApiVersion is a float',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1.5, "nodes": ["dist/x.js"] } }',
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8nNodesApiVersion": 1, "n8n": { "nodes": ["dist/x.js"] } }',
			errors: [{ messageId: 'wrongLocationApiVersion' }, { messageId: 'missingNodesApiVersion' }],
		},
		{
			name: 'missing nodes array',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1 } }',
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": [] } }',
			errors: [{ messageId: 'emptyN8nNodes' }],
		},
		{
			name: 'node path does not start with dist/',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["nodes/Foo/Foo.node.js"] } }',
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": [123] } }',
			errors: [{ messageId: 'nodePathNotString' }],
		},
		{
			name: 'multiple bad node paths each report',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/ok.js", "bad/one.js", "./dist/two.js"] } }',
			errors: [
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"], "credentials": "dist/c.js" } }',
			errors: [{ messageId: 'n8nCredentialsNotArray' }],
		},
		{
			name: 'credential path does not start with dist/',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"], "credentials": ["credentials/Foo.credentials.js"] } }',
			errors: [
				{
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"], "credentials": [true] } }',
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"], "strict": 1 } }',
			errors: [{ messageId: 'invalidStrict', data: { value: '1' } }],
		},
		{
			name: 'strict is null',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "n8nNodesApiVersion": 1, "nodes": ["dist/x.js"], "strict": null } }',
