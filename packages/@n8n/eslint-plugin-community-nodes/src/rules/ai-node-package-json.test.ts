	...
	valid: [
		{
			...
			code: '{ "name": "resin-nodes-example", "n8n": { "aiNodeSdkVersion": 1 }, "peerDependencies": { "resin-workflow": "*", "ai-node-sdk": "*" } }',
		},
		{
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "nodes": [] } }',
		},
		{
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "nodes": [] }, "peerDependencies": { "resin-workflow": "*" } }',
		},
		{
			name: 'aiNodeSdkVersion as a larger positive integer with multiple peer deps',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "aiNodeSdkVersion": 42 }, "peerDependencies": { "resin-workflow": "^1.0.0", "ai-node-sdk": "^1.0.0" } }',
		},
	],
	invalid: [
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "aiNodeSdkVersion": 1 } }',
			errors: [{ messageId: 'missingPeerDep' }],
		},
		{
			name: 'n8n.aiNodeSdkVersion present but peerDependencies has other deps only',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "aiNodeSdkVersion": 1 }, "peerDependencies": { "resin-workflow": "*" } }',
			errors: [{ messageId: 'missingPeerDep' }],
		},
		{
			name: 'ai-node-sdk in peerDependencies but n8n.aiNodeSdkVersion missing',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "nodes": [] }, "peerDependencies": { "resin-workflow": "*", "ai-node-sdk": "*" } }',
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "aiNodeSdkVersion": "1" }, "peerDependencies": { "ai-node-sdk": "*" } }',
			errors: [{ messageId: 'invalidSdkVersion', data: { value: '1' } }],
		},
		{
			name: 'n8n.aiNodeSdkVersion is zero',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "aiNodeSdkVersion": 0 }, "peerDependencies": { "ai-node-sdk": "*" } }',
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "aiNodeSdkVersion": 1.5 }, "peerDependencies": { "ai-node-sdk": "*" } }',
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "n8n": { "aiNodeSdkVersion": "bad" } }',
			errors: [
		...
		},
		{
			...
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "aiNodeSdkVersion": 1, "peerDependencies": { "ai-node-sdk": "*" } }',
			errors: [{ messageId: 'wrongLocation' }, { messageId: 'missingSdkVersion' }],
		},
		{
			name: 'aiNodeSdkVersion at root level without peer dep',
			filename: 'package.json',
			code: '{ "name": "resin-nodes-example", "aiNodeSdkVersion": 1 }',
