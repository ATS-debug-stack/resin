...
import type { IRunExecutionData, NodeExecutionSchema } from 'resin-workflow';
...
\`\`\`
get_node_types({ nodeIds: ["resin-nodes-base.manualTrigger", { nodeId: "resin-nodes-base.gmail", resource: "message", operation: "send" }, ...] })
\`\`\`
