...
export const suggestedNodesData: Record<string, CategoryData> = {
	...
	data_extraction: {
		...
		nodes: [
			...
			{ name: '@resin/n8n-nodes-langchain.informationExtractor', note: 'For unstructured text' },
			{
	...
	content_generation: {
		...
		nodes: [
			{ name: '@resin/n8n-nodes-langchain.agent', note: 'For text generation' },
			{
				name: '@resin/n8n-nodes-langchain.openAi',
				note: 'Use for image/video generation. DALL-E, TTS, Sora video generation',
			},
			{ name: '@resin/n8n-nodes-langchain.lmChatGoogleGemini', note: 'Imagen, video generation' },
