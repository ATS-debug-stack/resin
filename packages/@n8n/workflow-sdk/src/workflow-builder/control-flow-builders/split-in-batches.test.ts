...
type SibNode = NodeInstance<'resin-nodes-base.splitInBatches', string, unknown>;
...
describe('Split In Batches', () => {
	...
	describe('workflow integration', () => {
		it('should integrate splitInBatches with workflow builder', () => {
			...
			const foundSibNode = json.nodes.find((n) => n.type === 'resin-nodes-base.splitInBatches');
