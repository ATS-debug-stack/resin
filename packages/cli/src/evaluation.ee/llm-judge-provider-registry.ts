...
const PROVIDERS: ProviderEntry[] = [
	...
	{
		nodeType: '@resin/n8n-nodes-langchain.lmChatGoogleVertex',
		displayName: 'Google Vertex Chat Model',
		credentialTypes: [{ name: 'googleApi', displayName: 'Google Service Account' }],
	},
	{
		nodeType: '@resin/n8n-nodes-langchain.lmChatAzureOpenAi',
	...
	{
		nodeType: '@resin/n8n-nodes-langchain.lmChatDeepSeek',
		displayName: 'DeepSeek Chat Model',
		credentialTypes: [{ name: 'deepSeekApi', displayName: 'DeepSeek' }],
	},
	{
		nodeType: '@resin/n8n-nodes-langchain.lmChatCohere',
