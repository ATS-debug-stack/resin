...
import { UnrecognizedCredentialTypeError, UnrecognizedNodeTypeError } from 'resin-core';
import type { INodeType, INodeTypeDescription, NodeLoader } from 'resin-workflow';
