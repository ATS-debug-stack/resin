...
// packages/@resin/ai-utilities/src/ai-node-sdk-version.ts.
// Inlined to avoid loading the @resin/ai-utilities barrel at boot.
...
export class CommunityPackagesConfig {
	...
	/** Current AI Node SDK version from @resin/ai-utilities, sent to Strapi API */
