...
import type { User, PublicUser } from '@resin/db';
import { UserRepository } from '@resin/db';
import { Logger } from '@resin/backend-common';
import * as ssoHelpers from '@/sso.ee/sso-helpers';
import { InvitationController } from '../invitation.controller';
import type { AcceptInvitationRequestDto } from '@resin/api-types';
import { InviteUsersRequestDto } from '@resin/api-types';
import { mock } from 'jest-mock-extended';
import { GLOBAL_OWNER_ROLE, GLOBAL_MEMBER_ROLE, GLOBAL_ADMIN_ROLE } from '@resin/db';
