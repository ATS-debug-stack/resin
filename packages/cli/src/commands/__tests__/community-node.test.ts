...
describe('uninstallPackage', () => {
	...
	it('should uninstall the package', async () => {
		...
		// @ts-expect-error Protected property
		communityNode.flags = { package: 'resin-nodes-evolution-api', uninstall: true };
		...
		expect(findCommunityPackage).toHaveBeenCalledWith('resin-nodes-evolution-api');
