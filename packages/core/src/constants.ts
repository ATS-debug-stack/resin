...
export const HTTP_REQUEST_AS_TOOL_NODE_TYPE = 'resin-nodes-base.httpRequestTool';
export const HTTP_REQUEST_TOOL_NODE_TYPE = '@resin/n8n-nodes-langchain.toolHttpRequest';
